...
public class ExpListViewAdapterWithCheckbox extends BaseExpandableListAdapter {
    ...
    */
    ...
    public ArrayList<Integer> getSelectedIndexesInGroup(int mGroupPosition) {
        boolean getChecked[] = mChildCheckStates.get(mGroupPosition);
    ...
    */
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.list_item_with_cb, null);
...
//            Intent intent = new Intent(mContext , Browse.class);
